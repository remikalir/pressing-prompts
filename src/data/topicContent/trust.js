...
export const trustContent = {
  ...
  conversationStarters: [
    ...
    {
      id: "cs-trust-4",
      prompt: "Look at the \"Is it Safe to Use ChatGPT for Your Task?\" flowchart (link in topic resources). What are some scenarios where accurate output doesn't matter? How does the flowchart impact your thinking about your use of AI?",
      resources: [
        { title: "\"Is It Safe to Use ChatGPT for Your Task?\" flowchart (downloadable PDF)", url: "/is-it-safe-to-use-chatgpt.pdf" },
      ],
    },
